		...
		<div class="ost-archive-actions">
			<?php if ( is_user_logged_in() ) : ?>
				<button type="button" class="ost-create-timeline-btn" id="ost-open-create-timeline" aria-expanded="false" aria-controls="ost-create-timeline-form">
					<?php echo ost_lucide_icon( 'plus', 18 ); ?>
					...
					<a href="<?php the_permalink(); ?>" class="ost-timeline-card-link">
						...
						<?php else : ?>
							<div class="ost-timeline-card-thumb ost-timeline-card-placeholder">
								<?php echo ost_lucide_icon( 'calendar', 48 ); ?>
							</div>
						<?php endif; ?>
						<h2 class="ost-timeline-card-title"><?php the_title(); ?></h2>
					</a>
					<div class="ost-timeline-card-footer">
						<span class="ost-card-meta" title="צפיות"><?php echo ost_lucide_icon( 'eye', 16 ); ?> <?php echo esc_html( number_format_i18n( $views ) ); ?></span>
						<span class="ost-card-meta" title="לייקים"><?php echo ost_lucide_icon( 'heart', 16 ); ?> <?php echo esc_html( number_format_i18n( $likes ) ); ?></span>
					</div>
				</article>
				<?php
			endwhile;
